				...
				<table id="table" class="table table-bordered" style="border-width: 2px;">
					...
					<tbody>	
						...
						<tr>		
							...
							<td><?php echo round($total_rpl[0]/$krpl,2); ?></td>
							<td><?php echo round($total_rpl[1]/$krpl,2); ?></td>
							<td><?php echo round((($total_rpl[0]+$total_rpl[1])/(2*$krpl)),2); ?></td>
							<td><?php echo round($total_wwc[0]/$kwwc,2); ?></td>
							<td><?php echo round($total_wwc[1]/$kwwc,2); ?></td>
							<td><?php echo round((($total_wwc[0]+$total_wwc[1])/(2*$kwwc)),2); ?></td>
							<td><?php echo round($total_nilai,2); ?></td>
							<td><?php echo round((0.45*(($total_rpl[0]+$total_rpl[1])/(2*$krpl)))+(0.35*(($total_wwc[0]+$total_wwc[1])/(2*$kwwc)))+(0.20*$total_nilai),2); ?></td>
							<td><a class='btn btn-new-success btn-next' href='admin_rekap_nilai_cc_detail.php?id=<?php echo $id_user;?>' onclick='window.open("admin_rekap_nilai_cc_detail.php?id=<?php echo $id_user;?>", "newwindow", "width=750,height=500"); return false;'>DETAIL</a></td>
