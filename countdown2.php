...
<head>
	...
	<title>Indihome Frontliner Contest CSR Plasa Telkom Regional V 2022</title>
...
<script>
    ...
    function startTime() {
		...
		<?php
			...
			$endtime = date('F d, Y H:i:s',strtotime("+30 minutes"));
		?>
    ...
    function play() { 
		...
		'https://www.soundjay.com/buttons/sounds/beep-06.mp3'); 
		beepsound.play(); 
	} 
